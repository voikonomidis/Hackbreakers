...
public class DeleteDatabaseJDialog extends javax.swing.JDialog {
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteJButtonActionPerformed
        ...
        int inputValue = JOptionPane.showConfirmDialog(null,
                "Are you sure you want to delete database " + dbName, "Warning!", JOptionPane.YES_NO_OPTION);
        if (inputValue == 0) { //yes
            ...
            if (db.deleteDatabaseGUI(dbName)) {
                ...
                JOptionPane.showMessageDialog(this, "Could not delete database with name " + dbName + "...", "Other I/O error", JOptionPane.ERROR_MESSAGE);
            }
